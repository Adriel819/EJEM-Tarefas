        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          <div className="flex-1 flex flex-col gap-6">
            ...
            <div className="bg-stone-100 rounded-2xl p-6">
              ...
              className="bg-amber-600 hover:bg-amber-700 text-white text-center px-8 py-3 rounded-full uppercase tracking-widest text-sm transition-colors duration-300"
            >
              Abrir no Google Maps
            </a>
          </div>
          <div className="flex-1 w-full rounded-2xl overflow-hidden shadow-lg h-80">
            <iframe
