        ...
        {enviado ? (
          ...
          <div className="flex flex-col gap-4">
            <input
              ...
              className="bg-stone-800 text-white placeholder-stone-500 rounded-xl px-5 py-3 outline-none focus:ring-2 focus:ring-amber-500"
            />
            <input
              name="email"
              type="email"
            ...
            <textarea
              ...
              value={form.mensagem}
              onChange={handleChange}
              className="bg-stone-800 text-white placeholder-stone-500 rounded-xl px-5 py-3 outline-none focus:ring-2 focus:ring-amber-500 resize-none"
            />
            <button
